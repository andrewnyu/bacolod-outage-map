...
const SCHEDULE = {
  fetchedAt: "2026-09-08T13:26:39.800Z",
  sourceDate: "6 September 2026",
  source: { url: "https://www.facebook.com/photo.php?fbid=122232203060048473", label: "View the source post on Facebook" },
  rotation: {
  ...
  slots: {
    "Asdes-Gonzaga Feeder 1": { s: 13, e: 15, label: "1:00PM – 3:00PM" },
    ...
    "Mountain View Feeder 6": { s: 14, e: 16, label: "2:00PM – 4:00PM" },
    "Lopez Feeder 2": { s: 16, e: 18, label: "4:00PM – 6:00PM" },
    "Panaogao Feeder 2": { s: 16, e: 18, label: "4:00PM – 6:00PM" },
    "Reclamation Feeder 1": { s: 16, e: 18, label: "4:00PM – 6:00PM" },
    "Talisay Feeder 2": { s: 16, e: 18, label: "4:00PM – 6:00PM" },
    "Alijis Feeder 3": { s: 17, e: 19, label: "5:00PM – 7:00PM" },
    "Alijis Feeder 4": { s: 17, e: 19, label: "5:00PM – 7:00PM" },
    "Murcia Feeder 4": { s: 17, e: 19, label: "5:00PM – 7:00PM" },
    "Asdes-Gonzaga Feeder 2": { s: 18, e: 20, label: "6:00PM – 8:00PM" },
    "Murcia Feeder 1": { s: 18, e: 20, label: "6:00PM – 8:00PM" },
    "Reclamation Feeder 3": { s: 18, e: 20, label: "6:00PM – 8:00PM" },
    "Talisay Feeder 3": { s: 18, e: 20, label: "6:00PM – 8:00PM" },
    "Alijis Feeder 6": { s: 19, e: 21, label: "7:00PM – 9:00PM" },
    "Asdes-Gonzaga Feeder 3": { s: 19, e: 21, label: "7:00PM – 9:00PM" },
    "Hilangban Feeder 3": { s: 19, e: 21, label: "7:00PM – 9:00PM" },
    "Mountain View Feeder 3": { s: 19, e: 21, label: "7:00PM – 9:00PM" },
    "Reclamation Feeder 2": { s: 19, e: 21, label: "7:00PM – 9:00PM" },
    "Alijis Feeder 8": { s: 20, e: 22, label: "8:00PM – 10:00PM" },
    "Sum-ag Feeder 2": { s: 21, e: 23, label: "9:00PM – 11:00PM" },
  },
  scheduled: [
    {
