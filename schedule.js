...
const SCHEDULE = {
  fetchedAt: "2026-09-13T13:44:18.578Z",
  sourceDate: "6 September 2026",
  source: { url: "https://www.facebook.com/photo.php?fbid=122232786980048473", label: "View the source post on Facebook" },
  rotation: {
  ...
  slots: {
    ...
    "Talisay Feeder 2": { s: 13, e: 15, label: "1:00PM – 3:00PM" },
    "Talisay Feeder 3": { s: 13, e: 15, label: "1:00PM – 3:00PM" },
    "Alijis Feeder 4": { s: 14, e: 16, label: "2:00PM – 4:00PM" },
    "Hilangban Feeder 4": { s: 14, e: 16, label: "2:00PM – 4:00PM" },
    "Sum-ag Feeder 1": { s: 16, e: 18, label: "4:00PM – 6:00PM" },
    "Talisay Feeder 1": { s: 17, e: 19, label: "5:00PM – 7:00PM" },
    "Asdes-Gonzaga Feeder 3": { s: 18, e: 20, label: "6:00PM – 8:00PM" },
    "Mountain View Feeder 1": { s: 18, e: 20, label: "6:00PM – 8:00PM" },
    "Murcia Feeder 2": { s: 18, e: 20, label: "6:00PM – 8:00PM" },
    "Alijis Feeder 1": { s: 19, e: 21, label: "7:00PM – 9:00PM" },
    ...
    "Lopez Feeder 2": { s: 19, e: 21, label: "7:00PM – 9:00PM" },
    ...
    "Asdes-Gonzaga Feeder 1": { s: 20, e: 22, label: "8:00PM – 10:00PM" },
    "Hilangban Feeder 2": { s: 20, e: 22, label: "8:00PM – 10:00PM" },
    "Alijis Feeder 8": { s: 21, e: 23, label: "9:00PM – 11:00PM" },
    "Mountain View Feeder 3": { s: 21, e: 23, label: "9:00PM – 11:00PM" },
    "Reclamation Feeder 1": { s: 21, e: 23, label: "9:00PM – 11:00PM" },
  },
  scheduled: [
    {
