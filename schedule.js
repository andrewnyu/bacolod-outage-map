...
const SCHEDULE = {
  fetchedAt: "2026-09-09T09:16:52.118Z",
  sourceDate: "6 September 2026",
  source: { url: "https://www.facebook.com/photo.php?fbid=122232312380048473", label: "View the source post on Facebook" },
  rotation: {
  ...
  slots: {
    "Asdes-Gonzaga Feeder 2": { s: 13, e: 15, label: "1:00PM – 3:00PM" },
    "Reclamation Feeder 3": { s: 13, e: 15, label: "1:00PM – 3:00PM" },
    "Talisay Feeder 3": { s: 13, e: 15, label: "1:00PM – 3:00PM" },
    "Alijis Feeder 1": { s: 14, e: 16, label: "2:00PM – 4:00PM" },
    "Alijis Feeder 4": { s: 14, e: 16, label: "2:00PM – 4:00PM" },
    "Asdes-Gonzaga Feeder 3": { s: 15, e: 17, label: "3:00PM – 5:00PM" },
    "Hilangban Feeder 3": { s: 15, e: 17, label: "3:00PM – 5:00PM" },
    "Reclamation Feeder 2": { s: 15, e: 17, label: "3:00PM – 5:00PM" },
    "Alijis Feeder 8": { s: 16, e: 18, label: "4:00PM – 6:00PM" },
    "Mountain View Feeder 2": { s: 16, e: 18, label: "4:00PM – 6:00PM" },
    "Talisay Feeder 1": { s: 16, e: 18, label: "4:00PM – 6:00PM" },
    "Mountain View Feeder 1": { s: 17, e: 19, label: "5:00PM – 7:00PM" },
    "Murcia Feeder 2": { s: 17, e: 19, label: "5:00PM – 7:00PM" },
    "Sum-ag Feeder 1": { s: 17, e: 19, label: "5:00PM – 7:00PM" },
    "Sum-ag Feeder 2": { s: 17, e: 19, label: "5:00PM – 7:00PM" },
