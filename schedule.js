...
const SCHEDULE = {
  fetchedAt: "2026-09-16T14:07:30.373Z",
  sourceDate: "6 September 2026",
  source: { url: "https://www.facebook.com/photo.php?fbid=122233064804048473", label: "View the source post on Facebook" },
  rotation: {
  ...
  slots: {
    ...
    "Lopez Feeder 3": { s: 19, e: 21, label: "7:00PM – 9:00PM" },
    "Mountain View Feeder 6": { s: 19, e: 21, label: "7:00PM – 9:00PM" },
    "Alijis Feeder 1": { s: 20, e: 22, label: "8:00PM – 10:00PM" },
