...
const ZONES = [
  ...
  },
  {
    ...
    kind: "substation",
    confidence: "confirmed",
    feeders: ["Asdes-Gonzaga Feeder 1", "Asdes-Gonzaga Feeder 2", "Asdes-Gonzaga Feeder 3", "Asdes-Gonzaga Feeder 4", "Asdes-Gonzaga Feeder 5", "Asdes-Gonzaga Feeder 7"],
  ...
  },
  {
    ...
    kind: "substation",
    confidence: "confirmed",
    feeders: ["Reclamation Feeder 1", "Reclamation Feeder 2", "Reclamation Feeder 3", "Reclamation Feeder 5"],
  ...
  },
  {
    ...
    feeders: ["Alijis Feeder 1", "Alijis Feeder 2", "Alijis Feeder 3", "Alijis Feeder 4", "Alijis Feeder 5", "Alijis Feeder 8"],
  ...
  },
  {
    ...
    note: "Pinned on Talisay City, the municipality the feeders are named after. No substation in OpenStreetMap and no published area list.",
    areas: [],
  },
  {
    id: "lopez",
    ...
    kind: "pin",
    confidence: "guess",
    feeders: ["Lopez Feeder 1", "Lopez Feeder 2"],
    center: [10.66153, 122.95503],
    note: "Weak. Pinned on Lopez Jaena Street in Bacolod because the name matches; there is no evidence the Lopez feeders are fed from there. Treat the location as unknown.",
    areas: [],
  },
  {
    id: "hilangban",
    ...
    kind: "pin",
    confidence: "unknown",
    feeders: ["Hilangban Feeder 2", "Hilangban Feeder 3", "Hilangban Feeder 4"],
    center: [10.7, 122.975],
    note: "We could not find Hilangban anywhere \u2014 not in OpenStreetMap, not in Nominatim, not island-wide. This pin is a placeholder near the Bacolod-Talisay corridor and carries no evidence at all. Use the schedule, ignore the position.",
    areas: [],
  },
];
